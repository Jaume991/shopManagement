...
@Stateless
@Path("shiptype")
public class ShipTypeFacadeREST extends AbstractFacade<ShipType> {
    ...
    public void edit(@PathParam("id") Integer id, ShipType entity) {
        super.edit(entity);
    }
    ...
    public ShipType find(@PathParam("id") Integer id) {
